...
class ShiftTest extends TestCase
{
    ...
    public function testGetWorkPeriods()
    {
        ...
        $ShiftBreakMock->start_time = '2018-01-05 12:00:00';
        $ShiftBreakMock->end_time = '2018-01-05 13:00:00';
        ...
        $ShiftMock->start_time = '2018-01-05 10:00:00';
        $ShiftMock->end_time = '2018-01-05 15:00:00';
        ...
        $this->assertPeriod(['2018-01-05 10:00:00', '2018-01-05 12:00:00'], $periods[0]);
        $this->assertPeriod(['2018-01-05 13:00:00', '2018-01-05 15:00:00'], $periods[1]);
    }
}
