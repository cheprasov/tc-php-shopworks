...
class PeriodCollectionTest extends TestCase
{
    ...
    {
        $Period1 = PeriodFactory::createPeriod('2018-01-01 10:00:00', '2018-01-01 11:00:00');
        $Period2 = PeriodFactory::createPeriod('2018-01-01 12:00:00', '2018-01-01 13:00:00');
        $Period3 = PeriodFactory::createPeriod('2018-01-01 14:00:00', '2018-01-01 15:00:00');
    ...
    {
        $PeriodCollection = PeriodFactory::createCollection();
        $PeriodCollection->addPeriods(PeriodFactory::createPeriod('2018-01-01 10:00:00', '2018-01-01 18:00:00'));
        $PeriodCollection->addPeriods(PeriodFactory::createPeriod('2018-01-01 12:00:00', '2018-01-01 20:00:00'));
        $NewPeriodCollection = $PeriodCollection->split(
            PeriodFactory::createPeriod('2018-01-01 14:00:00', '2018-01-01 15:00:00')
        );

        $periods = $NewPeriodCollection->getPeriods();
        $this->assertSame(4, count($periods));

        $this->assertPeriod(['2018-01-01 10:00:00', '2018-01-01 14:00:00'], $periods[0]);
        $this->assertPeriod(['2018-01-01 15:00:00', '2018-01-01 18:00:00'], $periods[1]);
        $this->assertPeriod(['2018-01-01 12:00:00', '2018-01-01 14:00:00'], $periods[2]);
        $this->assertPeriod(['2018-01-01 15:00:00', '2018-01-01 20:00:00'], $periods[3]);
    }
    ...
    public function providerTestGetSinglePeriods()
    {
        return [
            ...
            'line_' . __LINE__ => [
                'periods' => [
                    ['2018-01-01 10:00:00', '2018-01-01 14:00:00'],
                ],
                'expect' => [
                    ['2018-01-01 10:00:00', '2018-01-01 14:00:00'],
                ],
            ...
            'line_' . __LINE__ => [
                'periods' => [
                    ['2018-01-01 10:00:00', '2018-01-01 14:00:00'],
                    ['2018-01-01 14:00:00', '2018-01-01 18:00:00'],
                ],
                'expect' => [
                    ['2018-01-01 10:00:00', '2018-01-01 14:00:00'],
                    ['2018-01-01 14:00:00', '2018-01-01 18:00:00'],
            ...
            'line_' . __LINE__ => [
                'periods' => [
                    ['2018-01-01 10:00:00', '2018-01-01 14:00:00'],
                    ['2018-01-01 10:00:00', '2018-01-01 18:00:00'],
                ],
                'expect' => [
                    ['2018-01-01 10:00:00', '2018-01-01 14:00:00'],
                    ['2018-01-01 14:00:00', '2018-01-01 18:00:00'],
            ...
            'line_' . __LINE__ => [
                'periods' => [
                    ['2018-01-01 10:00:00', '2018-01-01 20:00:00'],
                    ['2018-01-01 12:00:00', '2018-01-01 18:00:00'],
                    ['2018-01-01 14:00:00', '2018-01-01 16:00:00'],
                ],
                'expect' => [
                    ['2018-01-01 10:00:00', '2018-01-01 12:00:00'],
                    ['2018-01-01 12:00:00', '2018-01-01 14:00:00'],
                    ['2018-01-01 14:00:00', '2018-01-01 16:00:00'],
                    ['2018-01-01 16:00:00', '2018-01-01 18:00:00'],
                    ['2018-01-01 18:00:00', '2018-01-01 20:00:00'],
                ],
            ],
        ];
    }
    ...
    public function providerTestGetUniquePeriods()
    {
        return [
            ...
            'line_' . __LINE__ => [
                'periods' => [
                    ['2018-01-01 10:00:00', '2018-01-01 14:00:00'],
                    ['2018-01-01 12:00:00', '2018-01-01 16:00:00'],
                ],
                'expect' => [
                    ['2018-01-01 10:00:00', '2018-01-01 12:00:00'],
                    ['2018-01-01 14:00:00', '2018-01-01 16:00:00'],
            ...
            'line_' . __LINE__ => [
                'periods' => [
                    ['2018-01-01 10:00:00', '2018-01-01 20:00:00'],
                    ['2018-01-01 12:30:00', '2018-01-01 18:30:00'],
                ],
                'expect' => [
                    ['2018-01-01 10:00:00', '2018-01-01 12:30:00'],
                    ['2018-01-01 18:30:00', '2018-01-01 20:00:00'],
                ],
            ],
        ];
    }
    ...
    public function providerTestIsCoverPeriod()
    {
        return [
            'line_' . __LINE__ => [
                'periods' => [],
                'coverPeriod' => ['2018-01-01 11:00:00', '2018-01-01 12:00:00'],
                'expect' => false
            ],
            'line_' . __LINE__ => [
                'periods' => [
            ...
            'line_' . __LINE__ => [
                'periods' => [
                    ['2018-01-01 10:00:00', '2018-01-01 11:30:00'],
                    ['2018-01-01 11:30:00', '2018-01-01 12:00:00'],
                ],
                'coverPeriod' => ['2018-01-01 11:00:00', '2018-01-01 12:00:00'],
                'expect' => false
            ],
