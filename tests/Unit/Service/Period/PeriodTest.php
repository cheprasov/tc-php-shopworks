...
class PeriodTest extends TestCase
{
    public function providerTestGetMinutes()
    {
        return [
            ...
            'line_' . __LINE__ => [
                'startDate' => '2018-01-01 10:00:00',
                'endDate' => '2018-01-02 10:00:00',
                'expect' => 1440,
            ],
            'line_' . __LINE__ => [
                'startDate' => '2018-01-01 00:00:00',
                'endDate' => '2018-01-01 00:59:00',
                'expect' => 59,
            ],
            'line_' . __LINE__ => [
                'startDate' => '2018-01-01 00:00:00',
                'endDate' => '2018-01-01 00:59:59',
                'expect' => 60,
            ],
        ];
    }
    ...
    public function providerTestIsCoverPeriod()
    {
        return [
            'line_' . __LINE__ => [
                ...
                'endDate' => '2018-08-01 12:00:00',
                'startDate2' => '2018-08-01 10:00:00',
                'endDate2' => '2018-08-01 12:00:00',
                'expect' => true
            ],
            'line_' . __LINE__ => [
                'startDate' => '2018-08-01 10:00:00',
                'endDate' => '2018-08-01 12:00:00',
                'startDate2' => '2018-08-01 11:00:00',
                'endDate2' => '2018-08-01 12:00:00',
                'expect' => true
            ],
            'line_' . __LINE__ => [
            ...
            'line_' . __LINE__ => [
                ...
                'endDate' => '2018-08-01 12:00:00',
                'startDate2' => '2018-08-01 11:00:00',
                'endDate2' => '2018-08-01 11:30:00',
                'expect' => true
            ],
            'line_' . __LINE__ => [
                'startDate' => '2018-08-01 10:00:00',
                'endDate' => '2018-08-01 12:00:00',
                'startDate2' => '2018-08-02 10:00:00',
                'endDate2' => '2018-08-02 11:00:00',
                'expect' => false
            ],
            'line_' . __LINE__ => [
                'startDate' => '2018-08-01 10:00:00',
                'endDate' => '2018-08-01 12:00:00',
                'startDate2' => '2018-08-01 09:00:00',
                'endDate2' => '2018-08-01 11:00:00',
                'expect' => false
            ],
            'line_' . __LINE__ => [
    ...
    public function providerTestSplit()
    {
        return [
            'line_' . __LINE__ => [
                'period' => ['2018-08-01 10:00:00', '2018-08-01 12:00:00'],
                'split' => ['2018-08-01 10:00:00', '2018-08-01 12:00:00'],
                'expect' => [],
            ],
            'line_' . __LINE__ => [
                'period' => ['2018-08-01 10:00:00', '2018-08-01 12:00:00'],
                'split' => ['2018-08-01 09:00:00', '2018-08-01 13:00:00'],
                'expect' => [],
            ],
            'line_' . __LINE__ => [
                'period' => ['2018-08-01 10:00:00', '2018-08-01 12:00:00'],
                'split' => ['2018-08-01 10:00:00', '2018-08-01 11:00:00'],
                'expect' => [
                    ['2018-08-01 11:00:00', '2018-08-01 12:00:00'],
                ],
            ],
            'line_' . __LINE__ => [
                'period' => ['2018-08-01 10:00:00', '2018-08-01 12:00:00'],
                'split' => ['2018-08-01 11:00:00', '2018-08-01 13:00:00'],
                'expect' => [
            ...
            'line_' . __LINE__ => [
                'period' => ['2018-08-01 10:00:00', '2018-08-01 12:00:00'],
                'split' => ['2018-08-01 10:30:00', '2018-08-01 11:30:00'],
                'expect' => [
                    ['2018-08-01 10:00:00', '2018-08-01 10:30:00'],
                    ['2018-08-01 11:30:00', '2018-08-01 12:00:00'],
                ],
            ],
            'line_' . __LINE__ => [
                'period' => ['2018-08-01 10:00:00', '2018-08-02 10:00:00'],
                'split' => ['2018-08-01 18:00:00', '2018-08-01 20:59:00'],
                'expect' => [
                    ['2018-08-01 10:00:00', '2018-08-01 18:00:00'],
                    ['2018-08-01 20:59:00', '2018-08-02 10:00:00'],
                ],
            ],
        ];
    }
